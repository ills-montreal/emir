...
class RougeMatchingFunction(MatchingFunction):
    ...
    def __init__(self, rouge_type):
        self._rouge = rouge_scorer.RougeScorer([rouge_type])
...
#     ):
#         if isinstance(reference, list):
#             return [sacrebleu.sentence_chrf(c, r) for r, c in zip(reference, candidate)]
#         else:
...
#     ):
#         if isinstance(reference, list):
#             return [sacrebleu.sentence_bleu(c, r) for r, c in zip(reference, candidate)]
#         else:
