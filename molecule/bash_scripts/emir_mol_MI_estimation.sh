...
export NAME=run_4_notanh-512

echo "Running script on dataset $DATASET and model $MODELS in $NAME"
python main.py --dataset $DATASET --out-dir /home/fransou/scratch/DATA/results --X $MODELS --name $NAME --cond-modes 4 --marg-modes 4 --use-tanh false --ff-hidden-dim 512
