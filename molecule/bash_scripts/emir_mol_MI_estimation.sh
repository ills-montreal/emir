...
python main.py --dataset $DATASET --out-dir /home/fransou/scratch/DATA/results --X $MODELS --name $NAME --cond-modes 4 --marg-modes 4 --use-tanh false --ff-hidden-dim 256
