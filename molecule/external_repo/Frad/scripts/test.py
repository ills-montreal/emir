...
from molecule.external_repo.Frad.torchmdnet_frad.module import LNNP
from molecule.external_repo.Frad.torchmdnet_frad import datasets, priors, models
from molecule.external_repo.Frad.torchmdnet_frad.data import DataModule
from molecule.external_repo.Frad.torchmdnet_frad.models import output_modules
from molecule.external_repo.Frad.torchmdnet_frad.models.utils import rbf_class_mapping, act_class_mapping
from molecule.external_repo.Frad.torchmdnet_frad.utils import LoadFromFile, LoadFromCheckpoint, save_argparse, number
...
def main():
    ...
    test_res = trainer.test(model, datamodule=data)
    print(test_res)
